...
mediumShirts = runners.filter(item => item.shirt_size === "M");
...
biggerThanSmall= runners.filter(item => item.shirt_size !== "S");
console.log(biggerThanSmall);
// Problem 3

let allLower = [];
allLower = runners.map(item => item.first_name.toLowerCase());
